    ...
    <div className="w-full min-h-screen bg-gray-50 pb-24">
      ...
      <section className="relative w-full h-[30vh] bg-green-900 flex items-center justify-center">
        ...
        <div className="relative z-20 text-center">
          ...
          <p className="text-green-100 text-lg">Stay updated with the latest news and activities from CheonanFresh.</p>
        </div>
      </section>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-4">
          <div className="text-gray-600 font-medium">
            Total <span className="text-green-600 font-bold">{filteredNews.length}</span>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <ul className="divide-y divide-gray-100">
            {isLoading ? (
              <li className="py-20 text-center text-gray-500">Loading data...</li>
